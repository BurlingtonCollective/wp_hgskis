...
<main id="template-guts">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-8">
                <h1 class="sr-only">Eat The Guts</h1>
                ...
                <h2 class="text-center">A Video By HG Skis</h2>
                <img class="center-block img-responsive" src="<?php echo getThemeImg('/trailer-placeholder.jpg'); ?>">
                <a href="#" class="ski-sale-cta">
                    <img class="img-responsive center-block" src="<?php echo getThemeImg('/skis-sale-eat-the-guts.png'); ?>">
                </a>
                <a href="#" class="supported-by-cta">
                    <img class="img-responsive center-block" src="<?php echo getThemeImg('/supported-by.png'); ?>">
                </a>
                <a href="#" class="arts-riot-cta">
                ...
                <h2 class="text-center">#EATTHEGUTS</h2>
            </div>
            <div class="col-xs-10 col-xs-offset-1">
                <div class="row">
                    <div class="col-xs-3">
                        <blockquote class="instagram-media" data-instgrm-version="7" style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:658px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);"><div style="padding:8px;"> <div style=" background:#F8F8F8; line-height:0; margin-top:40px; padding:50.0% 0; text-align:center; width:100%;"> <div style=" background:url(data:image/png;base64,); display:block; height:44px; margin:0 auto -44px; position:relative; top:-22px; width:44px;"></div></div><p style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;"><a href="https://www.instagram.com/p/BDbaqWMI5kE/" style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;" target="_blank">A post shared by Zachary Lincoln (@zlincoln)</a> on <time style=" font-family:Arial,sans-serif; font-size:14px; line-height:17px;" datetime="2016-03-26T19:42:54+00:00">Mar 26, 2016 at 12:42pm PDT</time></p></div></blockquote>
                    </div>
                    <div class="col-xs-3">
                        <blockquote class="instagram-media" data-instgrm-version="7" style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:658px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);"><div style="padding:8px;"> <div style=" background:#F8F8F8; line-height:0; margin-top:40px; padding:50.0% 0; text-align:center; width:100%;"> <div style=" background:url(data:image/png;base64,); display:block; height:44px; margin:0 auto -44px; position:relative; top:-22px; width:44px;"></div></div><p style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;"><a href="https://www.instagram.com/p/BDbaqWMI5kE/" style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;" target="_blank">A post shared by Zachary Lincoln (@zlincoln)</a> on <time style=" font-family:Arial,sans-serif; font-size:14px; line-height:17px;" datetime="2016-03-26T19:42:54+00:00">Mar 26, 2016 at 12:42pm PDT</time></p></div></blockquote>
                    </div>
            ...
            <div class="col-xs-12 text-center">
                <a href="#" class="btn btn-default btn-guts more-cta">
                    More Guts
                </a>
            </div>
        </div>
