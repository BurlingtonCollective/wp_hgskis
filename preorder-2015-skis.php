	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				...
				<div class="wrapper wrapper-left">
					<h2 style="text-align: right; font-size: 18px;"><img class="img-responsive pull-left" src="<?= get_template_directory_uri(); ?>/images/stinger/title-logo.png" alt="Stinger"><span style="display: block; font-size: 12px; line-height: 14px; margin-bottom: 6px;">Spitfire Stinger</span>Full Camber Park Ski (169cm)</h2>
