<?php
/*
Template Name: Tall T Ski Template
*/
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-6">
				<div class="row product-wrapper" style="padding-bottom: 40px;">
					<div class="col-xs-6">
						<img class="img-responsive" src="<?= get_template_directory_uri(); ?>/images/topsheet.png">
						<img class="img-responsive" src="<?= get_template_directory_uri(); ?>/images/tall-t/saffari-top.png">
					</div>
					<div class="col-xs-6">
						<img class="img-responsive" src="<?= get_template_directory_uri(); ?>/images/base.png">
						<img class="img-responsive" src="<?= get_template_directory_uri(); ?>/images/tall-t/saffari-base.png">
					</div>
				</div>
